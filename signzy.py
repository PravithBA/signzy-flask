...
cred = {"username": "getfinstack_test", "password": "Zx5Dqp4Y47Yvbphrb7Nd"}
...
req_data = {
    ...
    "images": ["https://cdn.discordapp.com/attachments/840656221450010705/999562536854761482/IMG-20220701-WA0002.jpg"],
}

req_data = json.dumps(req_data)
identity_res = req.post(
    f"https://preproduction.signzy.tech/api/v2/patrons/{patreon_id}/identities",
    data=req_data,
    headers=headers,
)
...
req_data = {"task": "basicSearch", "essentials": {"vehicleNumber": "MH12GL3639"}}
req_data = json.dumps(req_data)
vehicle_res = req.post(
    f"https://preproduction.signzy.tech/api/v2/patrons/{patreon_id}/vehicleregistrations",
    data=req_data,
    headers=headers,
)
...
logout_res = req.post(
    f"https://preproduction.signzy.tech/api/v2/patrons/logout?access_token={auth_token}",
    data=cred,
)
print(logout_res)
